...
$var['params'] = (isset($var['params'])) ? $var['params'] : [];     //HTML parameters for the hidden input.
...
/** Custom parameters */
$var['id'] = (isset($var['id'])) ? $var['id'] : $var['name'];       //The html for the check box is not rendered using existing Form:: functions so the parameters(id, class) must be provided separately.
$var['class'] = (isset($var['class'])) ? $var['class'] : '';
$var['option'] = (isset($var['option'])) ? $var['option'] : '1';  //Option for the checkbox. Default is 'Yes'.
$var['checked_val'] = (isset($var['checked_val'])) ? $var['checked_val'] : '1';  //Option for the checkbox. Default is 'Yes'.
$var['unchecked_val'] = (isset($var['unchecked_val'])) ? $var['unchecked_val'] : '0';  //Option for the checkbox. Default is 'Yes'.
