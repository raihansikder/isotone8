...
@include('form.select-array',['var'=>['name'=>'type','label'=>'Type', 'container_class'=>'col-sm-3','options'=>['Forward'=>'Forward','Assign'=>'Assign','Backward'=>'Backward']]])
<div class="clearfix"></div>
@include('form.input-text',['var'=>['name'=>'assigned_for_days','label'=>'Assigned For Days', 'container_class'=>'col-sm-3']])
@include('form.input-text',['var'=>['name'=>'assigned_by_user_id','label'=>'Assigned By User', 'container_class'=>'col-sm-3']])
@include('form.input-text',['var'=>['name'=>'assigned_to_user_id','label'=>'Assigned To User', 'container_class'=>'col-sm-3']])

@include('form.textarea',['var'=>['name'=>'note','label'=>'Note', 'container_class'=>'col-sm-6']])
<div class="clearfix"></div>
@include('form.input-checkbox',['var'=>['name'=>'is_resolved','label'=>'Resolved', 'container_class'=>'col-sm-3']])
