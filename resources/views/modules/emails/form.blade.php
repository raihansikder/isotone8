...
@include('form.input-text',['var'=>['name'=>'cc','label'=>'CC', 'container_class'=>'col-sm-6']])
@include('form.input-text',['var'=>['name'=>'bcc','label'=>'BCC', 'container_class'=>'col-sm-6']])
<div class="clearfix"> </div>
@include('form.input-text',['var'=>['name'=>'email_subject','label'=>'Subject', 'container_class'=>'col-sm-6']])
<div class="clearfix"></div>
...
<div class="clearfix"> </div>
@include('form.textarea',['var'=>['name'=>'html','label'=>'Body', 'container_class'=>'col-sm-6']])
