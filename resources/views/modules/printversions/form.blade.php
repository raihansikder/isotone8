...
<div class="clearfix"> </div>
{{--todo need to change table names after modules are available--}}
@include('form.select-model',['var'=>['name'=>'printtemplate_id','label'=>'Print template','table'=>'printtemplates', 'container_class'=>'col-sm-3']])
@include('form.select-model',['var'=>['name'=>'printversiontype_id','label'=>'Print Version','table'=>'printversiontypes', 'container_class'=>'col-sm-3']])
<div class="clearfix"> </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function addValidationRulesForSaving() {
            ...
            $("input[name=printversiontype_id]").addClass('validate[required]');
        }
    </script>
    @if(!isset($$element))
        <script type="text/javascript">
