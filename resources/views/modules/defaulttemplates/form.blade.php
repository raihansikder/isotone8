...
{{--printtemplate_id--}}
@include('form.select-model', ['var'=>['name'=>'printtemplate_id','label'=>'Default Print Template','table'=>'printtemplates','container_class'=>'col-sm-6']])

{{--module_id--}}
@include('form.select-model', ['var'=>['name'=>'module_id','label'=>'Module (For which you are setting up default template)','table'=>'modules','container_class'=>'col-sm-6']])
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function addValidationRulesForSaving() {
            ...
            $("select[name=printtemplate_id]").addClass('validate[required]');
        }
    </script>
    @if(!isset($$element))
        <script type="text/javascript">
